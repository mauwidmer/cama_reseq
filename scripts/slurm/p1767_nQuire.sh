...
#SBATCH --job-name=nQuire_p1767
#SBATCH --partition=kenlab2
#SBATCH --nodelist=fgcz-kl-004
#SBATCH --output=./log/p1767_Cama_nQuire_%a.out
...
BAM="/scratch/maurin/cama_reseq/data/BAM/p1767/${SAMPLE_ID}.bam"

OUTDIR="/scratch/maurin/cama_reseq/results/nQuire/p1767"
mkdir -p "$OUTDIR"

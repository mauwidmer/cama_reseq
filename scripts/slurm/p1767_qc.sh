...
#SBATCH --job-name=qc_p1767
#SBATCH --partition=kenlab2
#SBATCH --nodelist=fgcz-kl-003
#SBATCH --output=./log/p1767_Cama_qc.out
...
OUTDIR="/srv/kenlab/maurin/cama_reseq/data/raw/reseqs/p1767_qc"
...
for sample in "${SAMPLE_LIST[@]}"; do
    ...
    fastqc --outdir "$FASTQC_OUTDIR" \
           ...
           "${INDIR}/${sample}_R1_001.fastq.gz" "${INDIR}/${sample}_R2_001.fastq.gz"
done
...
multiqc "$OUTDIR" --force --filename "Cama_p1767_mqc.html"

...
#SBATCH --job-name=nQuire_view_p1811
#SBATCH --partition=kenlab2
#SBATCH --nodelist=fgcz-kl-004
#SBATCH --output=./log/p1811_Cama_nQuire_view_%A_%a.out
...
# input/output
BINDIR="/scratch/maurin/cama_reseq/results/nQuire/p1811"
OUTDIR="/scratch/maurin/cama_reseq/results/nQuire/p1811/view"

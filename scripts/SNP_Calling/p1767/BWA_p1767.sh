...
SAMPLE_ID=$1
FASTQ_DIR="/scratch/maurin/cama_reseq/data/trimmed/reseqs/p1767_qc/trimmed"
GENOME="/srv/kenlab/maurin/cama_reseq/data/ref_genome/ca1.genome.fasta.gz"
BAM_DIR="/scratch/maurin/cama_reseq/data/BAM/p1767"
...
# FASTQ files
########################################
R1="${FASTQ_DIR}/${SAMPLE_ID}_R1_001_trimmed.fastq.gz"
R2="${FASTQ_DIR}/${SAMPLE_ID}_R2_001_trimmed.fastq.gz"
